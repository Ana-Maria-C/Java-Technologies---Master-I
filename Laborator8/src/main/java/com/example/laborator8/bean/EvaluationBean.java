...
import com.example.laborator8.decorator.EvaluationService;
...
import com.example.laborator8.observers.EvaluationCreatedEvent;
...
public class EvaluationBean implements Serializable {
    ...
    private final LocalDateTime evaluationStartDate = LocalDateTime.of(2024, 12, 1, 8, 0);
    private final LocalDateTime evaluationEndDate = LocalDateTime.of(2024, 12, 20, 24, 0);
